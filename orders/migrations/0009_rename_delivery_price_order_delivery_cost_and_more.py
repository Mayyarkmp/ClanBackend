...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0008_order_customer_order_delayed_acceptance_check_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.RenameField(
            model_name='order',
            old_name='delivery_price_currency',
            new_name='delivery_cost_currency',
        ),
        ...
        migrations.AddField(
            ...
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='SAR', max_digits=10, null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='preparation_cost_currency',
