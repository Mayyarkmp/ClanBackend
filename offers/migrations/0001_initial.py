    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_customers', models.PositiveIntegerField(blank=True, null=True, verbose_name='Max Customers')),
            ],
            options={
                'verbose_name': 'Promotion Branch Limit',
                'verbose_name_plural': 'Promotion Branch Limits',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_views_per_customer', models.PositiveIntegerField(blank=True, null=True, verbose_name='Max Views Per Customer')),
                ('applicable_delivery_types', models.CharField(choices=[('FAST', 'Fast'), ('SCHEDULED', 'Scheduled'), ('BOTH', 'Both')], default='BOTH', max_length=10)),
                ('applicable_platforms', models.CharField(choices=[('WEB', 'Web'), ('MOBILE', 'Mobile'), ('BOTH', 'Both')], default='BOTH', max_length=10)),
                ('max_total_quantity', models.PositiveIntegerField(blank=True, null=True, verbose_name='Max Total Quantity')),
                ('max_total_customers', models.PositiveIntegerField(blank=True, null=True, verbose_name='Max Total Customers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Promotion Region Limit',
                'verbose_name_plural': 'Promotion Region Limits',
            },
        ),
        migrations.CreateModel(
            name='PromotionTimeSlot',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
            ...
            options={
                'verbose_name': 'Promotion Time Slot',
                'verbose_name_plural': 'Promotion Time Slots',
            },
        ),
        migrations.CreateModel(
            name='PromotionUsage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_type', models.CharField(choices=[('IMPRESSION', 'Impression'), ('CLICK', 'Click'), ('ORDER', 'Order'), ('PURCHASE', 'Purchase')], max_length=20, verbose_name='Event Type')),
                ('platform', models.CharField(blank=True, max_length=20, null=True, verbose_name='Platform')),
                ...
                ('advertisement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='analytics', to='content_marketing.advertisement')),
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='branches.branch')),
                ('browsing_key', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='customers.browsingkey')),
            ],
            options={
